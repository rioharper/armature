...
- Winning idea needs requirements formalized or the trade matrix redone → **robotics-spec-design**
- Idea accepted, needs prototype/analysis tasks scheduled → **robotics-writing-plans**
- Idea's math needs deriving (new kinematic structure, compliance model) → **robotics-mathematician**
- User wants to actually understand how the exotic thing works → **robotics-teacher**
